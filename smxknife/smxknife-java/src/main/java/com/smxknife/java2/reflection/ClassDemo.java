...
public class ClassDemo extends Object implements Serializable {
	...
	public static void main(String[] args) {
		System.out.println(ClassDemo.class.toString()); // class com.smxknife.java2.reflection.ClassDemo
		System.out.println(ClassDemo.class.toGenericString()); // public class com.smxknife.java2.reflection.ClassDemo
