package com.smxknife.java2.thread.cyclicbarrier.demo03;
...
public class MyService {
	...
	private void beginRun(int count) {
		...
		try {
			...
			System.out.println("进入了InterruptedException " + barrier.isBroken());
			e.printStackTrace();
		} catch (BrokenBarrierException e) {
			System.out.println("进入了BrokenBarrierException " + barrier.isBroken());
			e.printStackTrace();
		}
	}
