package com.smxknife.netty.demo09;
...
public class HttpFileServerHandlerCopyFromWeb extends SimpleChannelInboundHandler<FullHttpRequest> {

	private final String url;

	public HttpFileServerHandlerCopyFromWeb(String url) {
		this.url = url;
	}
