 ...
 * 2019-06-18
 */
public class LazyInitializationWithNoVolatile {

	private LazyInitializationWithNoVolatile() {}

	private static LazyInitializationWithNoVolatile instance = null;

	public static LazyInitializationWithNoVolatile getInstance() {
		if (instance == null) {
			try {
			...
			instance = new LazyInitializationWithNoVolatile();
