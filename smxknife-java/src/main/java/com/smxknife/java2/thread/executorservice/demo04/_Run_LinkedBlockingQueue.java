 ...
 * 2020/6/11
 */
public class _Run_LinkedBlockingQueue {
	public static void main(String[] args) throws InterruptedException {
		//
		ThreadPoolExecutor executor = new ThreadPoolExecutor(5, 7, 10, TimeUnit.SECONDS, new LinkedBlockingQueue<>(5));

		IntStream.iterate(0, idx -> idx + 1).limit(13).mapToObj(idx -> new Runnable() {
			@SneakyThrows
			@Override
			public void run() {
