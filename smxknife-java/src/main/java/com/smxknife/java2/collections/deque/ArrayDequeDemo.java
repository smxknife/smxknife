...
public class ArrayDequeDemo {
	public static void main(String[] args) throws NoSuchFieldException {
		...
		System.out.println("peek从头检索，不删除，队列为空返回null");
		// String element = deque.element();
		System.out.println("element从头检索，不删除，队列为空抛出异常");
		String poll1 = deque.poll();
		System.out.println(poll1);
		System.out.println("poll从头检索，删除，队列为空返回null");
		// String remove = deque.remove();
		System.out.println("remove从头检索，删除，队列为空抛出异常");
		//boolean offer = deque.offer(null);
		System.out.println("offer向队列插入元素，不支持null");
		ArrayDeque<String> fulldeque = new ArrayDeque<>(7);
		fulldeque.add("test1");
		fulldeque.add("test2");
		fulldeque.add("test3");
		fulldeque.add("test4");
		...
		fulldeque.add("test7");
		fulldeque.add("test8");
		System.out.println(fulldeque);
		boolean hello = fulldeque.offer("hello");
		System.out.println("offer向有界已满队列添加元素，返回" + hello);
		System.out.println(fulldeque);
		boolean world = fulldeque.add("world");
		System.out.println("add向有界已满队列添加元素，抛出异常" + world);
