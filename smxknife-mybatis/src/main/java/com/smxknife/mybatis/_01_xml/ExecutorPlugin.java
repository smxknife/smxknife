...
public class ExecutorPlugin implements Interceptor {
	...
	public Object intercept(Invocation invocation) throws Throwable {
		...
		System.out.println("ExecutorPlugin intercept | " + proceed.getClass());
		return proceed;
	}
	...
	public Object plugin(Object target) {
		...
		if (Executor.class.isAssignableFrom(target.getClass())) {
			System.out.println("Executor plugin target | " + target.getClass());
			final Object plugin = Interceptor.super.plugin(target);
			System.out.println("Executor plugin plugin | " + plugin.getClass());
			return plugin;
		} else {
			return target;
		}
